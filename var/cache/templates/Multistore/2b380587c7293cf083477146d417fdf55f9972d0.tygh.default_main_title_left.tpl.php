<?php /* Smarty version Smarty-3.1.21, created on 2025-07-21 11:28:35
         compiled from "/var/www/www-root/data/www/repairmysauna.com/design/themes/Multistore/templates/blocks/wrappers/default_main_title_left.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14562011687dfa33e38b70-09892691%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2b380587c7293cf083477146d417fdf55f9972d0' => 
    array (
      0 => '/var/www/www-root/data/www/repairmysauna.com/design/themes/Multistore/templates/blocks/wrappers/default_main_title_left.tpl',
      1 => 1752993034,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '14562011687dfa33e38b70-09892691',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_687dfa33e485d8_09195365',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_687dfa33e485d8_09195365')) {function content_687dfa33e485d8_09195365($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/www-root/data/www/repairmysauna.com/app/functions/smarty_plugins/block.hook.php';
...
if ($_smarty_tpl->tpl_vars['content_alignment']->value=="RIGHT") {?> ty-float-right<?php } elseif ($_smarty_tpl->tpl_vars['content_alignment']->value=="LEFT") {?> ty-float-left<?php }?>">
        <?php if ($_smarty_tpl->tpl_vars['title']->value||trim(Smarty::$_smarty_vars['capture']['title'])) {?>
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"wrapper:mainbox_general_title_wrapper")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"wrapper:mainbox_general_title_wrapper"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                ...
                <h2 class="default-main-title text-left">
...
if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A") {?><span class="cm-template-box template-box" data-ca-te-template="blocks/wrappers/default_main_title_left.tpl" id="<?php echo smarty_function_set_id(array('name'=>"blocks/wrappers/default_main_title_left.tpl"),$_smarty_tpl);?>
