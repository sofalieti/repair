<?php /* Smarty version Smarty-3.1.21, created on 2025-07-21 11:11:28
         compiled from "/var/www/www-root/data/www/repairmysauna.com/design/themes/Multistore/templates/addons/form_builder/hooks/pages/page_content.override.tpl" */ ?>
<?php /*%%SmartyHeaderCode:876953045687df6305210f5-51142657%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '41792bcb3e5a03ad96c32186949cf35f048bd85a' => 
    array (
      0 => '/var/www/www-root/data/www/repairmysauna.com/design/themes/Multistore/templates/addons/form_builder/hooks/pages/page_content.override.tpl',
      1 => 1752993073,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '876953045687df6305210f5-51142657',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_687df630597563_36949474',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_687df630597563_36949474')) {function content_687df630597563_36949474($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/www-root/data/www/repairmysauna.com/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_in_array')) include '/var/www/www-root/data/www/repairmysauna.com/app/functions/smarty_plugins/modifier.in_array.php';
if (!is_callable('smarty_function_script')) include '/var/www/www-root/data/www/repairmysauna.com/app/functions/smarty_plugins/function.script.php';
...
if ($_smarty_tpl->tpl_vars['page']->value['page_type']==@constant('PAGE_TYPE_FORM')) {?>
    <?php $_smarty_tpl->tpl_vars["form_label_as_placeholder"] = new Smarty_variable(@constant('FORM_LABEL_AS_PLACEHOLDER'), null, 0);?>
    ...
    <?php } else { ?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['page']->value['form_left']) {?>
            <div class="row flex-row-reverse">
            <?php }?>

            <?php if ($_smarty_tpl->tpl_vars['page']->value['description']) {?>
                <div class="ty-form-builder__description <?php if ($_smarty_tpl->tpl_vars['page']->value['form_left']) {?>col-md-8<?php }?>"><?php echo $_smarty_tpl->tpl_vars['page']->value['description'];?>
</div>
            <?php }?>

            <div class="ty-form-builder ty-form-builder-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'UTF-8');?>
 <?php if ($_smarty_tpl->tpl_vars['page']->value['form_left']) {?>col-md-8<?php }?>">
...
?>
                        ...
                        <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_HEADER')) {?>
                            ...
                            <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>$_smarty_tpl->tpl_vars['element']->value['description'],'class'=>"ty-subheader form_group_".((string)$_smarty_tpl->tpl_vars['element']->value['element_id'])), 0);?>


                        <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_OPEN_GROUP')) {?>

                            <div class="form-elements-group <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['css_class'], ENT_QUOTES, 'UTF-8');?>
">

                            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_CLOSE_GROUP')) {?>
                        ...
                        <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']!=@constant('FORM_IP_ADDRESS')&&$_smarty_tpl->tpl_vars['element']->value['element_type']!=@constant('FORM_REFERER')) {?>
                            <div class="form-group ty-control-group <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['css_class'], ENT_QUOTES, 'UTF-8');?>
" id="form_group_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
">
                                <?php if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_RADIO')||$_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_CHECKBOX')||$_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_MULTIPLE_SB')||$_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_MULTIPLE_CB')||$_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_FILE')) {?>
...
if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_PHONE')) {?> cm-phone<?php }?> <?php if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_MULTIPLE_CB')) {?>cm-multiple-checkboxes<?php }?> cm-label-type-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_type'], ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['description'], ENT_QUOTES, 'UTF-8');?>
</label>
                                <?php } elseif ($_smarty_tpl->tpl_vars['page']->value['form']['general'][$_smarty_tpl->tpl_vars['form_label_as_placeholder']->value]!="Y") {?>
                                    <label for="<?php if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_FILE')) {?>type_<?php echo htmlspecialchars(md5("fb_files[".((string)$_smarty_tpl->tpl_vars['element']->value['element_id'])."]"), ENT_QUOTES, 'UTF-8');
} else { ?>elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');
}?>" class="ty-control-group__title <?php if ($_smarty_tpl->tpl_vars['element']->value['required']=="Y") {?>cm-required<?php }
if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_EMAIL')) {?> cm-email<?php }
...
}?>" class="hidden ty-control-group__title <?php if ($_smarty_tpl->tpl_vars['element']->value['required']=="Y") {?>cm-required<?php }
if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_EMAIL')) {?> cm-email<?php }
if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_PHONE')) {?> cm-phone<?php }?> <?php if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_MULTIPLE_CB')) {?>cm-multiple-checkboxes<?php }?> cm-label-type-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_type'], ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['description'], ENT_QUOTES, 'UTF-8');?>
</label>
...
" class="form-control ty-form-builder__select" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
]" <?php if ($_smarty_tpl->tpl_vars['page']->value['form']['general'][$_smarty_tpl->tpl_vars['form_label_as_placeholder']->value]=="Y") {?>placeholder="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['description'], ENT_QUOTES, 'UTF-8');?>
"<?php }?>>
                                        <option label="" value="">-  <?php if ($_smarty_tpl->tpl_vars['page']->value['form']['general'][$_smarty_tpl->tpl_vars['form_label_as_placeholder']->value]=="Y") {
...
" class="ty-form-builder__checkbox checkbox" <?php if ($_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value]=="Y") {?>checked="checked"<?php }?> type="checkbox" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
                                ...
                                <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_MULTIPLE_SB')) {?>
                                    <select class="form-control  ty-form-builder__multiple-select" id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
...
" />
                                ...
                                <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_INPUT')) {?>
                                    <input id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
" class="form-control  ty-form-builder__input-text ty-input-text <?php if ($_smarty_tpl->tpl_vars['element']->value['position']==1) {?>cm-focus <?php }?>" size="50" type="text" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
...
" class="form-control  ty-form-builder__textarea" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
]" cols="67" rows="10" <?php if ($_smarty_tpl->tpl_vars['page']->value['form']['general'][$_smarty_tpl->tpl_vars['form_label_as_placeholder']->value]=="Y") {?>placeholder="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['description'], ENT_QUOTES, 'UTF-8');?>
"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value], ENT_QUOTES, 'UTF-8');?>
</textarea>

                                <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_DATE')) {?>
                                    <?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['description'], ENT_QUOTES, 'UTF-8');?>
<?php $_tmp1=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/calendar.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('placeholder'=>$_tmp1,'date_name'=>"form_values[".((string)$_smarty_tpl->tpl_vars['element']->value['element_id'])."]",'date_id'=>"elm_".((string)$_smarty_tpl->tpl_vars['element']->value['element_id']),'date_val'=>$_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value]), 0);?>
...
" />
                                    <?php }?>
                                    <input id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
" class="form-control  ty-input-text <?php if ($_smarty_tpl->tpl_vars['element']->value['position']==1) {?>cm-focus <?php }?>" size="50" type="text" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value], ENT_QUOTES, 'UTF-8');?>
"  <?php if ($_smarty_tpl->tpl_vars['page']->value['form']['general'][$_smarty_tpl->tpl_vars['form_label_as_placeholder']->value]=="Y") {?>placeholder="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['description'], ENT_QUOTES, 'UTF-8');?>
"<?php }?> />
                                ...
                                <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_COUNTRIES')) {?>
                                    ...
                                    <select id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
]" class="form-control  ty-form-builder__country cm-country cm-location-billing">
...
" <?php if ($_smarty_tpl->tpl_vars['_country']->value==$_smarty_tpl->tpl_vars['code']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['country']->value, ENT_QUOTES, 'UTF-8');?>
                                ...
                                <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_STATES')) {?>
                                    ...
                                    <select class="form-control ty-form-builder__state cm-state cm-location-billing" id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
]">
                                        <option label="" value="">- <?php echo $_smarty_tpl->__("select_state");?>
 -</option>
                                    </select>
                                    <input type="text" class="form-control  cm-state cm-location-billing ty-input-text hidden" id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
...
" disabled="disabled" />
                                ...
                                <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_MULTI_IMAGES')) {?>
                                    <input type="file" name="file_fb_images[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
][]" multiple id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
"/>
                                <?php }?>
                    ...
                    <div class="form-elements-group ty-form-builder__buttons buttons-container text-right">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_role'=>"submit",'but_text'=>__("submit"),'but_meta'=>"btn-primary btn-block",'but_name'=>"dispatch[pages.send_form]"), 0);?>
...
"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value], ENT_QUOTES, 'UTF-8');?>
                                ...
                                <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_DATE')) {?>
                                    <?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['description'], ENT_QUOTES, 'UTF-8');?>
<?php $_tmp2=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/calendar.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('placeholder'=>$_tmp2,'date_name'=>"form_values[".((string)$_smarty_tpl->tpl_vars['element']->value['element_id'])."]",'date_id'=>"elm_".((string)$_smarty_tpl->tpl_vars['element']->value['element_id']),'date_val'=>$_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value]), 0);?>
