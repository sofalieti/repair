<?php /* Smarty version Smarty-3.1.21, created on 2025-07-21 11:11:28
         compiled from "/var/www/www-root/data/www/repairmysauna.com/design/themes/Multistore/templates/blocks/topmenu_dropdown.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2097870640687df630494f19-29187325%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9967ede04d344b00b06096eadc40f5b4cd5ce2e6' => 
    array (
      0 => '/var/www/www-root/data/www/repairmysauna.com/design/themes/Multistore/templates/blocks/topmenu_dropdown.tpl',
      1 => 1752993031,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2097870640687df630494f19-29187325',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_687df6304c4d89_85064426',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_687df6304c4d89_85064426')) {function content_687df6304c4d89_85064426($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/www-root/data/www/repairmysauna.com/app/functions/smarty_plugins/block.hook.php';
...
?>
				...
				<li class="nav-item  css_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item1']->value['param_id'], ENT_QUOTES, 'UTF-8');?>
_menu_top ty-menu__item<?php if (!$_smarty_tpl->tpl_vars['item1']->value[$_smarty_tpl->tpl_vars['childs']->value]) {?> ty-menu__item-nodrop<?php } else { ?> cm-menu-item-responsive<?php }
...
if ($_smarty_tpl->tpl_vars['item1']->value['class']) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item1']->value['class'], ENT_QUOTES, 'UTF-8');
						...
						<?php if ($_smarty_tpl->tpl_vars['item1']->value[$_smarty_tpl->tpl_vars['childs']->value]) {?>
							<a class="css_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item1']->value['param_id'], ENT_QUOTES, 'UTF-8');?>
_menu_bot ty-menu__item-toggle visible-phone cm-responsive-menu-toggle">
...
"<?php }?> class="ty-menu__item-link css_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item1']->value['param_id'], ENT_QUOTES, 'UTF-8');?>
_menu_bot">
						   <?php if ($_smarty_tpl->tpl_vars['item1']->value[$_smarty_tpl->tpl_vars['name']->value]=='HOME_ICON') {?><img src="/images/companies/1/guruhome2.png" class="d-none d-md-inline"/>&nbsp;<span class="d-sm-inline d-md-none">Home</span><?php } else {
echo htmlspecialchars($_smarty_tpl->tpl_vars['item1']->value[$_smarty_tpl->tpl_vars['name']->value], ENT_QUOTES, 'UTF-8');
}?>
						</a>
					<?php if ($_smarty_tpl->tpl_vars['item1']->value[$_smarty_tpl->tpl_vars['childs']->value]) {?>
						...
						<?php if (!fn_check_second_level_child_array($_smarty_tpl->tpl_vars['item1']->value[$_smarty_tpl->tpl_vars['childs']->value],$_smarty_tpl->tpl_vars['childs']->value)) {?>
							...
							<div class="ty-menu__submenu ">
								<ul class="ty-menu__submenu-items ty-menu__submenu-items-simple cm-responsive-menu-submenu submenu<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item1']->value['param_id'], ENT_QUOTES, 'UTF-8');?>
">
