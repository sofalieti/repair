...
<div class="ty-calendar__block">
    <input placeholder="{$placeholder}" type="text" id="{$date_id}" name="{$date_name}" class="ty-calendar__input{if $date_meta} {$date_meta}{/if} cm-calendar form-control" value="{if $date_val}{$date_val|date_format:"`$date_format`"}{/if}" {$extra} size="10" />
