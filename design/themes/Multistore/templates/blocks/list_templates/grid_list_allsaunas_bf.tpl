			...
			<div class="grid_price">	            	
				...
				<div style="">
					...
					{if $product.MSRP}
						...
						<span style="">Rebate: <b>${math equation="x + y" x=$product.discounts.A y=0}</b></span><br>
				
						<span style="">Price: <b>${math equation="x - y - z" x=$first_price y=$product.discounts.A z = 0}</b></span><br/>
