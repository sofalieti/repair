{* $Id: grid_list_allsaunas.tpl 10220 2010-07-27 09:09:00Z alexions $ *}
<div class="allsaunas_class">
{if $products}
			...
			<div class="grid_price">	            	
				...
				<center>
					<div class="MySaunaSpanPrices">
						...
						<span style="">Price: <b>${$product.price} </b></span><br/>
                        <span>Web Price: <b>${$product.price-$product.discounts.A}</b></span>						
						...
						<div style="prices-block">
							{if ($product.price ne $product.WebPrice || $product.price == 0) || $show_request_a_price}
							<span> {$smarty.capture.$price nofilter}</span>
							{else}
