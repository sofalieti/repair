...
<div class="ty-product-block ty-product-detail fullproduct">
    <div class="ty-product-block__wrapper clearfix">
	 ...
	 {if !$hide_title} <h1  class="ty-product-block-title enlightentitle"  >Enlighten</h1><br>
                        <h1 class="ty-product-block-title" {live_edit name="product:product:{$product.product_id}"}>{$product.product nofilter} Full Spectrum Sauna</h1>
                    {/if}
    ...
    {hook name="products:view_main_info"}
        {if $product}
            ...
            <div class="ty-product-block__img-wrapper span4 ProductImageLayer">
  ...
  <div class="ty-product-block__field-group">
	  ...
	  <div class="ty-product-block__advanced-option">
				...
				<div class="span11 ProductDescriptionLayer">
...
<div class="product_block ">
	...
	<div class="wf-icons-block">
		<div class="item"><img src="/design/themes/Multistore/media/images/wf1.jpg"/><br/>NEAR INFRARED</div>
		<div class="item"><img src="/design/themes/Multistore/media/images/wf2.jpg"/><br/>MID INFRARED</div>
		<div class="item"><img src="/design/themes/Multistore/media/images/wf3.png"/><br/>FAR INFRARED</div>
	</div>
	<div class="is-fully-customizable-text">
		<img src="/design/themes/Multistore/media/images/rs.png"/> {$product.product} is fully customizable and convertible into an indoor unit. Ask us!
	</div>
</div>

	<center>{include file="blocks/product_templates/BuyLayerSmall.tpl"}</center>
...
<div class="product_block specificationlayer ">
...
<div class="cm-tabs-content ty-tabs__content clearfix content-tabsh" id="tabs_content">
	...
	{include file="blocks/product_templates/BuyLayer.tpl"}
...
<div class="GreyBg100 product-detail-review-block">
	{$product_blog.blog_product_text nofilter}
</div>
<div class="text-center product-detail-review-bt-block">
