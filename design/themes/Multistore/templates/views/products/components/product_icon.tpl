{capture name="main_icon"}
    <a href="{"products.view?product_id=`$product.product_id`"|fn_url}">
		...
		{else}
		{include file="common/image.tpl" obj_id=$obj_id_prefix images=$product.image_pairs|current image_width=$settings.Thumbnails.product_lists_thumbnail_width image_height=$settings.Thumbnails.product_lists_thumbnail_height}
		{/if}
	</a>
{/capture}
