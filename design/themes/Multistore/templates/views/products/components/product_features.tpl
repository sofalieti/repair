{foreach from=$product_features item="feature"}
    {if $feature.feature_type != "ProductFeatures::GROUP"|enum}
        <div class="ty-product-feature feauture-row-{$feature.feature_id}">
        ...
        {strip}
        <div class="ty-product-feature__value" id="feature_{$feature.feature_id}">
            ...
            {else}
				{if isset($replace_height) && $replace_height != false && $feature.description == "Height"}
				{$replace_height}
				{else}
