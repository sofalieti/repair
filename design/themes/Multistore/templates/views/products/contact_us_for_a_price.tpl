<div class="contact_us_for_a_price">         
    <form action="{""|fn_url}" method="post">
        ...
        <input type="hidden" name="contact_us_for_a_price[product_id]" value="{$smarty.get.product_id}" />   
        <input type="hidden" name="contact_us_for_a_price[product]" value="{$smarty.get.product}" />      
        ...
        {*<div class="form-group">
            ...
            <select name="contact_us_for_a_price[sauna_type]" id="contact_us_for_a_price_sauna_type">
        ...
        {*<div class="checkbox-as-image">
            <label class="active">
                ...
                <input checked="" type="radio" name="contact_us_for_a_price[sauna_type]" value="Outdoor Variant" onchange="$('.checkbox-as-image label').removeClass('active');$(this).parent('label').addClass('active');">
                Outdoor Variant
            </label>
            <label>
                <img src="/design/themes/Multistore/media/images/indooricon.png"><br>
                <input type="radio" name="contact_us_for_a_price[sauna_type]" value="Indoor Variant" onchange="$('.checkbox-as-image label').removeClass('active');$(this).parent('label').addClass('active');">
                Indoor Variant
            </label>
        </div>*}
        ...
        {*<div class="form-group">
            ...
            <select id="contact_us_for_a_price_whb" name="contact_us_for_a_price[WHB]" class="form-control">
                <option value="">-</option>
        ...
        <div class="form-group text-right">
            {include file="buttons/button.tpl" but_meta="btn-primary" but_role="submit" but_text='Send' but_name="dispatch[products.contact_us_for_a_price]"}
        </div>
    </form>      
</div>
{literal}
