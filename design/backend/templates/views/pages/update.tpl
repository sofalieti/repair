...
<div id="update_page_form_{$page_data.page_id}">
    ...
    <fieldset>
		...
		<div class="control-group">
		  <label class="control-label" for="elm_page_is_container">Container?:</label>
		  <div class="controls">
			  <input type="hidden" name="page_data[is_container]" value="0">
				<span class="checkbox">
					<input type="checkbox" name="page_data[is_container]" id="elm_page_is_container" {if $page_data.is_container == 1}checked="checked"{/if} value="1"/>
				</span>
		  </div>
		</div>
		<div class="control-group">
		  <label class="control-label" for="elm_page_form_left">Form left?:</label>
		  <div class="controls">
			  <input type="hidden" name="page_data[form_left]" value="0">
				<span class="checkbox">
					<input type="checkbox" name="page_data[form_left]" id="elm_page_form_left" {if $page_data.form_left == 1}checked="checked"{/if} value="1"/>
				</span>
		  </div>
		</div>
		...
		<div class="control-group">
            <label class="control-label" for="elm_page_short_descr">Short description:</label>
            <div class="controls">
                <textarea id="elm_page_short_descr" name="page_data[short_description]" cols="55" rows="8" class="cm-wysiwyg input-large">{$page_data.short_description}</textarea>
            </div>
        </div>
		{/if}
	...
	{include file="common/subheader.tpl" title="Icon/Settings" target="#pages_icon"}
	<div id="pages_availability_setting" class="in collapse">
		<fieldset>
			<div class="control-group">
				<label class="control-label">{__("images")}:</label>
				<div class="controls">
					{include file="common/attach_images.tpl" image_name="page_image_main" image_object_type="page_image" image_pair=$page_data.main_pair icon_text=__("text_product_thumbnail") detailed_text=__("text_product_detailed_image") no_thumbnail=true}
				</div>
			</div>
			{if $page_type != $smarty.const.PAGE_TYPE_BLOG}
			<div class="control-group">
              <label class="control-label" for="elm_page_show_child_pages">Show child pages:</label>
              <div class="controls">
                  <input type="hidden" name="page_data[show_child_pages]" value="N">
                    <span class="checkbox">
                        <input type="checkbox" name="page_data[show_child_pages]" id="elm_page_show_child_pages" {if $page_data.show_child_pages == "Y"}checked="checked"{/if} value="Y"/>
                    </span>
              </div>
			</div>
			{/if}
			{if $page_type == $smarty.const.PAGE_TYPE_BLOG}
			<div class="control-group">
              <label class="control-label" for="elm_page_show_on_main_page">Show review on main pages:</label>
              <div class="controls">
                  <input type="hidden" name="page_data[show_on_main_page]" value="N">
                    <span class="checkbox">
                        <input type="checkbox" name="page_data[show_on_main_page]" id="elm_page_show_on_main_page" {if $page_data.show_on_main_page == "Y"}checked="checked"{/if} value="Y"/>
                    </span>
              </div>
			</div>
			{/if}
