...
<tr class="cm-row-status-{$state.status|lower}">
	...
	<td class="right">
		<a href="{"states_descriptions.edit?state_id=`$state.state_id`"|fn_url}">Edit</a>
    </td>
	<td class="right">
...
{capture name="tools"}
    ...
    <fieldset>
		...
		<div class="control-group">
            ...
            <div class="controls">
            <textarea id="elm_state_description1" name="state_data[description1]" cols="55" rows="8" class="input-large"></textarea>
            </div>
        </div>
		<div class="control-group">
            <label class="control-label" for="elm_state_description2">Description bottom:</label>
            <div class="controls">
            <textarea id="elm_state_description2" name="state_data[description2]" cols="55" rows="8" class="input-large"></textarea>
            </div>
        </div>
