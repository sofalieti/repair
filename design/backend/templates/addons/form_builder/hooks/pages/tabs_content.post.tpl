...
<div id="content_build_form">
	...
	<div class="control-group">
        <label for="form_redirect_url" class="control-label">Redirect url:</label>
        {assign var="form_redirect_url_const" value=$smarty.const.FORM_REDIRECT_URL}
        <div class="controls">
            <input id="form_redirect_url" class="input-text" type="text" name="page_data[form][general][{$form_redirect_url_const}]" value="{$form.$form_redirect_url_const}">
        </div>
    </div>
	
	<div class="control-group">
        <label for="form_label_as_placeholder" class="control-label">Label as placeholder:</label>
        {assign var="form_label_as_placeholder" value=$smarty.const.FORM_LABEL_AS_PLACEHOLDER}
        <div class="controls">
			<input type="hidden" name="page_data[form][general][{$form_label_as_placeholder}]" value="N">
			<span class="checkbox">
				<input type="checkbox" id="form_label_as_placeholder" value="Y" {if $form.$form_label_as_placeholder == "Y"}checked="checked"{/if} name="page_data[form][general][{$form_label_as_placeholder}]">
			</span>
		</div>
    </div>
