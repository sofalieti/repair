...
<script type="text/javascript">
    function fn_check_element_type(elm, id, selectable_elements)
    {
        ...
        $('#descr_' + id).toggleBy((elm == 'D' || elm == 'O' || elm == 'E'));
        $('#hr_' + id).toggleBy((elm != 'D' && elm != 'O' && elm != 'E'));

        $('#req_' + id).prop('disabled', (elm == 'D' || elm == 'H' || elm == 'O' || elm == 'E'));
    }
...
<tr>
    ...
    <td>
        <input class="input-small" type="text" size="10" name="page_data[form][elements_data][{$num}][css_class]" value="{$element.css_class}" /></td>
	<td>
...
<tr class="no-border">
    ...
    <td>
        <input class="input-small" type="text" size="10" name="page_data[form][elements_data][{$num}][css_class]" value="" /></td>
	<td>
